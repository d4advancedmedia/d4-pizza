...
// Update this version number in the description area as well for cache busting. Use this variable as the version number in registers for scripts and styles so that a single change to this number will force a version refresh for all Arsenal files. You can still version the js and css files separately, this just denotes the version of the plugin as a whole.
$d4pizza_version = '7Mar17f';
